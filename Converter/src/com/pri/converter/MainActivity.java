	...
	public void onClick(View v) 
	{
     switch (v.getId()) {
		...
		case R.id.buttonsubmit:
			...
			{
				Toast.makeText(MainActivity.this,"Please enter a value to calculate in the appropriate fields",Toast.LENGTH_SHORT).show();
			}
