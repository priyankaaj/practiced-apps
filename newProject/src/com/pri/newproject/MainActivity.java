...
public class MainActivity extends Activity implements OnClickListener 
{
    ...
    public String fartodeg()
    {
		...
		fahrenheitval = enteredval2.getText().toString();
    ...
    public String miltomet()
    {
    	...
    	entmilli = enteredval2.getText().toString();
    ...
    public String doltorup()
    {
    	...
    	entdollars = enteredval2.getText().toString();
		...
		case R.id.buttonsubmit:
			if(spinneroption[position]==spinneroption[0])
				{    
					...
					}else if(enteredval1.length() == 0 && enteredval2.length() == 0)
					{
						Toast.makeText(MainActivity.this,"Invalid input. Enter values to calculate", Toast.LENGTH_SHORT).show();
					}
				...
				}else if(spinneroption[position]==spinneroption[2])
				{
					if(enteredval1.length() > 0)
					{
						enteredval2.setText(ruptodol());
					}
					else if(enteredval2.length() > 0)
					{
							enteredval1.setText(doltorup());
					}else if(enteredval1.length() == 0 && enteredval2.length() == 0)
					{
						Toast.makeText(MainActivity.this,"Invalid input. Enter values to calculate", Toast.LENGTH_SHORT).show();
					}
